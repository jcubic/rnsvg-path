...
const MySVG = ({style, toggle}) => {
  return (
    <Svg viewBox="0 0 32 32" style={style}>
      {toggle && <Path d="M 16 16 m 16, 0 a 16,16 0 1,1 -32,0 a r,r 0 1,1 32,0" stroke="#000"/>}
      {!toggle && <Path d="M 16 16 m 16, 0 a 16,16 0 1,1 -32,0 a 16,16 0 1,1 32,0" stroke="#000"/>}
    </Svg>
  );
};
